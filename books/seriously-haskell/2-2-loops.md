...
再び再帰の登場です。再帰とパターンマッチでリストを走査する場合、最も表現が高くなると思います:
...
[^4]: Haskell は制約の強い言語であるため、書きやすい Haskell を求めている内に自然とそれらしくなると思います。僕の場合は、ポイントフリースタイルを多用する (ことが楽しい) という方針を得てからは Haskell の書き方が安定して行きました。
