...
=recip= の実装は、 ACL の実装に合わせて法が素数かで分岐します。 ACL はコンパイル時に分岐していますが、 =ac-library-hs= の =ModInt= では実行時に分岐しています。法が素数の場合は [[https://ja.wikipedia.org/wiki/%E3%83%95%E3%82%A7%E3%83%AB%E3%83%9E%E3%83%BC%E3%81%AE%E5%B0%8F%E5%AE%9A%E7%90%86][フェルマーの小定理]] により $x^{-1} \equiv x^{p-2} \mod m$ です:
